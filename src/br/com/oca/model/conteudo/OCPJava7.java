...
/**
 * 
 * A Classe OCPJava7 preenxe todas as questões referentes ao Exame Oracle
 * Certified Professional, Java SE 7 Programmer.
 * 
 * Classe <code>OCPJava7</code>
 * 
...
public class OCPJava7 extends Conteudo {
	...
	/**
	 * 
	 * Cria uma Nova Instância da Classe OCPJava7
	 * 
	 * @param exame
	 ...
	 */
	protected OCPJava7(Certificacao exame, Idioma idiomaTeste, TipoTeste tipoTeste) {
	 ...
	 * @param tipoTeste
	 *            O Tipo de Teste (30, 60 ou 90 Questões).
	 * @return A Instância da Classe OCPJava7.
	 */
	public static OCPJava7 getInstance(Certificacao exame, Idioma idiomaTeste, TipoTeste tipoTeste) {

		if (instance == null) {
			synchronized (OCPJava7.class) {
				if (instance == null) {
					instance = new OCPJava7(exame, idiomaTeste, tipoTeste);
				}
			}
		}
	...
	protected void preenxerTeste60Questoes() {
		...
		addQuestao(TESTE_60_QUESTOES, 4, new HashMap<Character, String>() {
			{
				put('A', perguntasSource.getString("teste60.exercicio4.opcao_0"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 5, new HashMap<Character, String>() {
			{
				put('C', perguntasSource.getString("teste60.exercicio5.opcao_2"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 7, new HashMap<Character, String>() {
			{
				put('E', perguntasSource.getString("teste60.exercicio7.opcao_4"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 9, new HashMap<Character, String>() {
			{
				put('D', perguntasSource.getString("teste60.exercicio9.opcao_3"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 25, new HashMap<Character, String>() {
			{
				put('C', perguntasSource.getString("teste60.exercicio25.opcao_2"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 28, new HashMap<Character, String>() {
			{
				put('B', perguntasSource.getString("teste60.exercicio28.opcao_1"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 29, new HashMap<Character, String>() {
			{
				put('C', perguntasSource.getString("teste60.exercicio29.opcao_2"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 30, new HashMap<Character, String>() {
			{
				put('B', perguntasSource.getString("teste60.exercicio30.opcao_1"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 34, new HashMap<Character, String>() {
			{
				put('A', perguntasSource.getString("teste60.exercicio34.opcao_0"));
				put('C', perguntasSource.getString("teste60.exercicio34.opcao_2"));
				put('D', perguntasSource.getString("teste60.exercicio34.opcao_3"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 35, new HashMap<Character, String>() {
			{
				put('B', perguntasSource.getString("teste60.exercicio35.opcao_1"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 36, new HashMap<Character, String>() {
			{
				put('D', perguntasSource.getString("teste60.exercicio36.opcao_3"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 39, new HashMap<Character, String>() {
			{
				put('B', perguntasSource.getString("teste60.exercicio39.opcao_1"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 40, new HashMap<Character, String>() {
			{
				put('A', perguntasSource.getString("teste60.exercicio40.opcao_0"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 41, new HashMap<Character, String>() {
			{
				put('C', perguntasSource.getString("teste60.exercicio41.opcao_2"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 42, new HashMap<Character, String>() {
			{
				...
				put('E', perguntasSource.getString("teste60.exercicio42.opcao_4"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 43, new HashMap<Character, String>() {
			{
				put('C', perguntasSource.getString("teste60.exercicio43.opcao_2"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 44, new HashMap<Character, String>() {
			{
				put('C', perguntasSource.getString("teste60.exercicio44.opcao_2"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 45, new HashMap<Character, String>() {
			{
				put('B', perguntasSource.getString("teste60.exercicio45.opcao_1"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 46, new HashMap<Character, String>() {
			{
				put('C', perguntasSource.getString("teste60.exercicio46.opcao_2"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 48, new HashMap<Character, String>() {
			{
				put('D', perguntasSource.getString("teste60.exercicio48.opcao_3"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 51, new HashMap<Character, String>() {
			{
				put('A', perguntasSource.getString("teste60.exercicio51.opcao_0"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 55, new HashMap<Character, String>() {
			{
				put('A', perguntasSource.getString("teste60.exercicio55.opcao_0"));
			}
		});
		...
		addQuestao(TESTE_60_QUESTOES, 59, new HashMap<Character, String>() {
			{
				put('E', perguntasSource.getString("teste60.exercicio58.opcao_4"));
			}
		});

		addQuestao(TESTE_60_QUESTOES, 60, new HashMap<Character, String>() {
			{
				put('B', perguntasSource.getString("teste60.exercicio60.opcao_2"));
				put('C', perguntasSource.getString("teste60.exercicio60.opcao_2"));
			}
		});
